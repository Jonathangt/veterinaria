            ...
            <div class="card">
                ...
                <template v-else-if="template==0">
                    <div class="text-center"><br>
                         <Label><b class="labelContacto"> Registro del Cliente</b></Label>
                    </div>
                     <div class="col-md-12">
                     ...
                     <div class="card-body">            
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary" @click="registrar()">Registrar Cliente</button>
                            </div>
                        </div>
                 ...
                 <template v-else-if="template==3">
                    ...
                    <div class="card-body">            
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button type="button" @click="cerrarTemplateRegistro()" class="btn btn-primary">Cerrar</button>
                                <button type="submit" class="btn btn-primary" @click="actualizar()">Actualizar Cliente</button>
                            </div>
                        </div>
                    </div><!--fin 2do card body-->
                </template>
